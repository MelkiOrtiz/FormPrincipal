...
import umg.ejercicios.DataBase.Service.UserService;
...
//    private JPanel jPanelUsuarios;
    ...
    private JButton buttonActualizarUsuarios;
    private JButton buttonBuscarUsuario;
    private JButton buttonEliminarUsuairo;
    ...
    public Usuarios() {
        ...
        buttonActualizarUsuarios.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
        ...
        buttonEliminarUsuairo.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
